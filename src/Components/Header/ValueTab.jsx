    ...
    <div>
        <div className="drop-tab1-value">
            <div>
                ...
                >
                   <Link className='value-link' to='value-propositons/ExtendedSupplyChainOptimization'>Extended Supply Chain Optimization</Link>
                </button>
                <button
                    className={`tablinks ${activeTab === 'ealm' ? 'active' : ''}`}
                    onMouseOver={() => openCity('ealm')}
                >
                   <Link className='value-link' to='value-propositons/EnduringAssetLifecycleManagement'>Enduring Asset Lifecycle Management</Link>
                ...
                >
                   <Link className='value-link' to='value-propositons/BusinessPartnerLifeCycleManagement'>Maturing Business Partner Lifecycle Management</Link>
                </button>
                <button
                    className={`tablinks ${activeTab === 'sdmaeac' ? 'active' : ''}`}
                    onMouseOver={() => openCity('sdmaeac')}
                >
                   <Link className='value-link' to='Value-Propositions/Seamless-Data-Migration-and-Effective-Application-Consolidation'>Seamless Data Migration and Effective Application Consolidation</Link>
                ...
                >
                   <Link className='value-link' to='ESCO'>Digital Transformation and Automation</Link>
